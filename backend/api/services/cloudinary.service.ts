...
export async function uploadPromoImageBuffer(params: {
  buffer: Buffer;
  filename?: string;
}) {
  ensureCloudinaryConfigured();
...
export async function uploadSectionImageBuffer(params: {
  buffer: Buffer;
  filename?: string;
}) {
  ensureCloudinaryConfigured();
...
export async function uploadCategoryImageBuffer(params: {
  buffer: Buffer;
  filename?: string;
}) {
  ensureCloudinaryConfigured();
